...
With the hypothesis that the micro-environmental variation is equally distributed over all the individuals (i.e. all the plants), the distribution of each germplasm represents the intra-germplasm variance.
This has to be taken with caution:
    - If germplasm have no intra-germplasm variance (i.e. pure line or hybrides) then the distribution of each germplasm represents only the micro-environmental variation.
    - If germplasm have intra-germplasm variance (i.e. populations or landraces) then the distribution of each germplasm represents the micro-environmental variation plus the intra-germplasm variance.
